<template>
    <div class="main h-mainPng bg-no-repeat bg-center">
      <div class="container mx-auto text-white text-center">
        ...
        <div class="h-14 bg-sky-600 mt-24 flex justify-start items-center px-8 2xl:visible xl:visible lg:visible md:visible sm:invisible invisible">
        ...
        <div class="container mx-auto">
          <div class="flex justify-center items-end mt-20">
            <div class="flex flex-col">
              ...
              <div class="  font-bold mb-16 text-xl  2xl:text-2xl xl:text-2xl lg:text-2xl md:text-2xl sm:text-xl">Показатели эффективности</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <form>   
      ...
      <div class="relative">
          ...
          <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Поиск</button>
      </div>
  </form>
  <div date-rangepicker class="flex justify-center  space-x-10 items-center mt-5">
    ...
    <div class="relative">
      ...
      <div class="container mx-auto text-justify mt-24 mb-12">
        <div class="overflow-x-auto relative">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead class="text-xs text-center text-white uppercase bg-sky-700 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                  <th scope="col" class="py-3 px-6 rounded-l-lg border  ">
                    год
                  </th>
          ...
          <tbody class="text-center">
              <tr class="bg-white dark:bg-gray-800">
                  ...
                  <td class=" flex items-center space-x-12  text-center ml-14 text-xs mt-6">
              ...
              <tr class="bg-white dark:bg-gray-800">
                  <th scope="row" rowspan="4" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      2021
                  </th>
                  <td class="py-4 px-6">
                    ключевые показатели эффективности ГП "Центрального депозитария ценных бумаг" 
